...
#SBATCH --job-name="bcl2_ssecst_binder_nodesign"
#SBATCH --output=bcl2_ssecst_binder_nodesign_%A.out
#SBATCH --error=bcl2_ssecst_binder_nodesign_%A.err
...
NSTRUCT=1000
EXPERIMENT="ssecst"
EXPCOMPLEMENT="binder_from4oyd_nodesign"
JOBID=4
