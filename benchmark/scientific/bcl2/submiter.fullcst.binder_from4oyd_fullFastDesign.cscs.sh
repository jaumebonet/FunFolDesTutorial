...
#SBATCH --job-name="bcl2_fullcst_binder_from4oyd_fullFastDesign"
#SBATCH --output=bcl2_fullcst_binder_from4oyd_fullFastDesign_%A.out
#SBATCH --error=bcl2_fullcst_binder_from4oyd_fullFastDesign_%A.err
...
NSTRUCT=500
EXPERIMENT="fullcst"
EXPCOMPLEMENT="binder_from4oyd_fullFastDesign"
JOBID=6
