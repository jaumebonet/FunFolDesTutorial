...
#SBATCH --job-name="bcl2_fullcst_binder_from4oyd_minimize"
#SBATCH --output=bcl2_fullcst_binder_from4oyd_minimize_%A.out
#SBATCH --error=bcl2_fullcst_binder_from4oyd_minimize_%A.err
...
NSTRUCT=500
EXPERIMENT="fullcst"
EXPCOMPLEMENT="binder_from4oyd_minimize"
JOBID=5
